    ...
    <main class="content flex-grow-1">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="text-primary">Kelola Kategori 🏷️</h2>
                <a href="category_add.php" class="btn btn-success">Tambah Kategori Baru</a>
            </div>
            
            <?php if (empty($cats)): ?>
                <div class="alert alert-info border-0">Belum ada kategori yang ditambahkan.</div>
            <?php else: ?>
                                    ...
                                    <?php foreach($cats as $c): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="category_delete.php?id=<?php echo $c['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus kategori ini?')">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
